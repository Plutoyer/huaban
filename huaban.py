...
class HuabanCrawler():
   ...
   def __init__(self):
        self.home_url = "http://huaban.com/boards/481662/"
        self.images = []
        if not os.path.exists('E:\\花瓣'):
            os.mkdir('C:\\Users\mty\Desktop\huaban')
   ...
   def download_images(self):
        ...
        for key, image in enumerate(self.images):
            ...
            try:
                ...
                print('error')
            image_fullname = os.path.join("E:\\花瓣", image["id"] + "." + image["type"])
